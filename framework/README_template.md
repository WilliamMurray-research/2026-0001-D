...
| Version | Change |
|---|---|
| v0.0.2 | Added `scripts/` sub-structure; added `tests/` sub-structure; replaced `src/main.py` with language-agnostic placeholder; added `versions/` naming convention (§7); added `NOTICE` file and pre-commit hook guidance (§8–9); added compliance table |
